...
namespace SchoolProject.Classes
{
    public partial class frmEditClassInfo : Form
    {
        ...
        public frmEditClassInfo(int ClassID)
        {
            InitializeComponent();
        ...
        private void frmEditClass_Load(object sender, EventArgs e)
        {
            ...
            if(_Class != null )
            {
                txtTitle.Text = _Class.ClassName;
                txtFees.Text = _Class.ClassFees.ToString();
            }
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _Class.ClassName = txtTitle.Text;
            _Class.ClassFees = Convert.ToSingle(txtFees.Text.Trim());
        ...
        private void txtTitle_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (clsClass.IsClassNameAvailable(txtTitle.Text.Trim()))
            {
                e.Cancel = true;
                errorProvider1.SetError(txtTitle, "This Class is alrady exists");
            }
            else
            {
                errorProvider1.SetError(txtTitle, null);
